...
SECRET_KEY = 'django-insecure-#er)y29&g41f-31r@@vzp5_fja+i$dgnpj+(mh+(c=r5uyq09$'
...
TEMPLATES = [
    {
        ...
        'APP_DIRS': True,
        'OPTIONS': {
            'string_if_invalid': f'Invalid template variable {{%s}}',
            'context_processors': [
...
if socket.gethostname() == CS_DEPLOYMENT_HOSTNAME:
    STATIC_URL = '/akayas/static/'
    MEDIA_URL = '/akayas/media/'